...
/* 2022-10-07 -- V01	-- David V. 	-- Versionado, cambio de nombre, mail de notificación, export AWS
/* 2022-10-06 -- V00 	-- Original 	-- Creado en base al original diario, refect. por Benja Martinez
*/
...
/*=========== PROCESO CIERRE DE MES DAP =========================*/

/*==============================================================*/
/*======IDEAL QUE SE EJECUTE EL 1 Y EL 2 PARA VALIDACIONES======*/
/*==============================================================*/
...
call symput('fechai',"TO_DATE('"||input(put(intnx('month',today(),-1,'end'),DDMMYYD10. ),$10.)||"','DD-MM-YYYY')");
call symput('fechap',"TO_DATE('"||input(put(intnx('month',today(),-1,'end'),DDMMYYD10. ),$10.)||"','DD-MM-YYYY')");;RUN;

%put &periodo; /*periodo m-1 */
...
%DELETE_INCREM_PER_DIARIO(sas_ppff_detalle_stock_dap,raw,sasdata,-1); /*detalle_stock_dap*/
%DELETE_INCREM_PER_DIARIO(sas_ppff_stock_dap,raw,sasdata,-1); /*stock_dap*/

%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_ppff_detalle_stock_dap,RESULT.DETALLE_STOCK_DAP_&var_dia01.,raw,sasdata,-1); /*detalle_stock_dap*/
%INCREM_PER_DIARIO(sas_ppff_stock_dap,PUBLICIN.STOCK_DAP_&periodo.,raw,sasdata,-1); /*stock_dap*/
...
SUBJECT="MAIL_AUTOM: PROCESO STOCK_DAP_CIERRE" ;
FILE OUTBOX;
PUT 'Estimados:';
 PUT "Proceso STOCK_DAP_CIERRE, ejecutado con fecha: &fechaeDVN";  
 PUT ; 
