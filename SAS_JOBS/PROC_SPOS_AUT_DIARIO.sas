...
%DELETE_INCREM_PER_DIARIO(sas_spos_aut,raw,sasdata,0);

/*Exportación a AWS*/
%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_spos_aut,&libreria..spos_aut_&periodo.,raw,sasdata,0);
...
SUBJECT = ("MAIL_AUTOM: Proceso PROC_SPOS_AUT_DIARIO");
FILE OUTBOX;
 PUT "Estimados:";
 PUT "		Proceso SPOS_AUT, ejecutado con fecha: &fechaeDVN";  
