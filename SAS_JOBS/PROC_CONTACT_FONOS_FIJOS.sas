...
/* 2023-05-26 --v2-- Se agrega exportación a AWS 
...
%DELETE_BULK(SAS_CTBL_FONOS_FIJOS_FINAL_SE,raw,sasdata,0);
%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT.sas";
%EXPORTACION(SAS_CTBL_FONOS_FIJOS_FINAL_SE,PUBLICIN.FONOS_FIJOS_FINAL_SE,raw,sasdata,0);
