...
%DELETE_INCREM_PER_DIARIO(sas_ppff_trx_av,raw,sasdata,0);

/*Exportación a AWS*/
%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_ppff_trx_av,&libreria..trx_av_&Periodo.,raw,sasdata,0);
...
SUBJECT = ("MAIL_AUTOM: Proceso TRX_AV_ACTUAL");
FILE OUTBOX;
 PUT "Estimados:";
 PUT "		Proceso TRX_AV_ACTUAL, ejecutado automáticamente con fecha: &fechaeDVN";  
 PUT ;
 PUT ;
 PUT ;
 PUT 'Proceso Vers. 05'; 
