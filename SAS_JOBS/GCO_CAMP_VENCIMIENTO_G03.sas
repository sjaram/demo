...
/* 2020-11-11 -- V1 -- David V. --  
					-- Versión Original
/* INFORMACIÓN:
	Campaña INFORMATIVA 03 - Vencimiento Plastico

	(IN) Tablas requeridas o conexiones a BD:
	- RESULT.VENCIMIENTOS_&VdateHOY

	(OUT) Tablas de Salida o resultado:
 	- &libreria..POPINF_C_DETAL_03_CAMP_&fgen
	- &libreria..POPINF_C_ENCAB_03_CAMP_&fgen
*/
...
/*	VARIABLE LIBRERÍA			*/
%let libreria 		= RESULT;
%let camp_enc 		= POPCRV_C_ENCAB_03_CAMP_;
%let camp_det 		= POPCRV_C_DETAL_03_CAMP_;
%let grupo			= 3;
%let TIP_PROD		= '12';
%let COND_PRD		= '1203';
%let ARCH_GCO		= GCO_INI_IC00018;			/*	Correglativo desde el 16 al 20 disponibles */
%let codigo_camp	= 'CAMPCRV03';
					/* MAX LARGO11*/
%let desc_camp		= 'CRV - VENCIMIENTO DE PLASTICO - G03';
