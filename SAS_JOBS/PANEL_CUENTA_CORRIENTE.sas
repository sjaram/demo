...
/*==================================	PANEL_CUENTA_CORRIENTE		================================*/
/* CONTROL DE VERSIONES
/* 2023-09-12 -- v02 -- Esteban P.		-- Se añade sentencia para habilitar carácteres especiales.
/* 2023-09-11 -- v01 -- Benja Martínez	-- Original para el servidor
*/
/*==================================================================================================*/
...
%put &=EDP_BI;	%put &=DEST_1;	%put &=DEST_2;	%put &=DEST_3;	%put &=DEST_4;	%put &=DEST_6;
...
SUBJECT = ("MAIL_AUTOM: Proceso PANEL_CUENTA_CORRIENTE");
FILE OUTBOX;
 PUT "Estimados:";
 put "  Proceso PANEL_CUENTA_CORRIENTE, ejecutado con fecha: &fechaeDVN";  
 PUT ;
 PUT ;
 PUT ;
 PUT 'Proceso Vers. 02'; 
