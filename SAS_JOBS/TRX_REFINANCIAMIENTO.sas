...
%DELETE_INCREM_PER_DIARIO(sas_ppff_trx_ref,raw,sasdata,0);

/*Exportación a AWS*/
%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_ppff_trx_ref,publicin.TRX_REF_&fechax.,raw,sasdata,0);
...
FILE OUTBOX;
 PUT "Estimados:";
 PUT "		Proceso TRX_REFINANCIAMIENTO, ejecutado automáticamente con fecha: &fechaeDVN";  
 PUT ;
 PUT ;
 PUT ;
 PUT 'Proceso Vers. 03'; 
