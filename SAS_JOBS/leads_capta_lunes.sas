...
/* 2022-07-12 -- V04	-- David V. 	-- Ajustes mínimos, versionado, correo, etc.
/* 2022-07-11 -- V03 	-- Benjamín M. 	-- Últimos cambios
...
INI_FISA = put(intnx('day',today(),-3,'begin'),ddmmyy10.);
...
SUBJECT = ("MAIL_AUTOM: Proceso LEADS_CAPTA_LUNES - Interno");
FILE OUTBOX;
 PUT "Estimados:";
 PUT "        	Proceso LEADS_CAPTA_LUNES, ejecutado con fecha: &fechaeDVN";   
