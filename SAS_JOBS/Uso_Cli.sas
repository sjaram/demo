...
%let Ventana_Tiempo=12; /*Ventana para seguimiento*/
...
SB_mover_anomes(calculated Periodo_f,-1*&Ventana_Tiempo) as Periodo_i,
SB_mover_anomes(calculated Periodo_f,-1*(&Ventana_Tiempo+&Ventana_Recencia)) as Periodo_i2   
into 
:Periodo_f,
:Periodo_i,
:Periodo_i2 
