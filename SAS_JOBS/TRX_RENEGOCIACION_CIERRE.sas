...
/*==================================	TRX_RENEGOCIACION_CIERRE	================================*/
/* CONTROL DE VERSIONES
/* 2022-11-03 -- V03 -- Sergio J.-- Se actualizar export a AWS, según nuevas definiciones a RAW.
...
%macro principal();
%LET NOMBRE_PROCESO = 'TRX_RENEGOCIACION_CIERRE';
...
%DELETE_INCREM_PER_DIARIO(sas_ppff_trx_rene,raw,sasdata,-1);

%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_ppff_trx_rene,PUBLICIN.TRX_RENE_&fechax.,raw,sasdata,-1);
...
FILE OUTBOX;
 PUT "Estimados:";
 put "    Proceso TRX_RENEGOCIACION_CIERRE, ejecutado Exitosamente con fecha: &fechaeDVN";  
 put ; 
 PUT ;
 PUT ;
 PUT 'Proceso Vers. 03'; 
