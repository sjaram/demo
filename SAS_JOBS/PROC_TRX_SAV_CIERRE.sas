...
/* 2023-08-18 -- v11 -- Alejandra M.-- Se elimina del proceso una tabla que quedaba en duro (APROB_SAV_&Periodo.)y se deja tabla de paso*/
...
/*========================================================================================================================*/
/*==================================	 PROC_TRX_SAV_CIERRE - VERSION 20200701 		==================================*/
/*========================================================================================================================*/
...
%DELETE_INCREM_PER_DIARIO(sas_ppff_trx_sav,raw,sasdata,-1);

/*Exportación a AWS*/
%INCLUDE"/sasdata/users_BI/RESULTADOS/oradiag_user_bi/AWS/AWS_EXPORT_INCREM_PER_DIARIO.sas";
%INCREM_PER_DIARIO(sas_ppff_trx_sav,&libreria..trx_sav_&periodo,raw,sasdata,-1);
...
SUBJECT = ("MAIL_AUTOM: Proceso PROC_TRX_SAV_CIERRE");
FILE OUTBOX;
 PUT "Estimados:";
 put "  Proceso PROC_TRX_SAV_CIERRE, ejecutado con fecha: &fechaeDVN";  
 PUT ;
 PUT ;
 PUT ;
 PUT 'Proceso Vers. 10'; 
