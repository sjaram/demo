...
/* 2021-08-04 -- V1 -- Sergio J. --  
					-- VERSIÓN INICIAL
/* INFORMACIÓN:
	Disponibiliza la información de los clientes D10 para CAR en SAS
...
data _null_;
TABLA = COMPRESS('D10_'||&fechaMES.||'_CAR'," ",);
...
/* Variable ruta */
data _null_;
VAR = COMPRESS('/sasdata/users94/archivos_dat_proc/D10_'||&fechahf.||'_CAR.txt'," ",);
...
SUBJECT = ("MAIL_AUTOM: Proceso D10_AUT_CAR");
FILE OUTBOX;
 PUT "Estimados:";
 put "  Proceso D10_AUT_CAR, ejecutado con fecha: &fechaeDVN";  
