CALL schm_artifacts.sp_ppff_variables_motor_precios_final(schm_artifacts.f_period(trunc(DATEADD(MM,-2,current_date))), schm_artifacts.f_period(trunc(DATEADD(MM,+1,current_date))));
